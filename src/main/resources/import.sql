...
-- Customer Address
INSERT INTO `transaction`.`customer_address` (`customer_id`, `addresses_id`) VALUES(1, 1);
INSERT INTO `transaction`.`customer_address` (`customer_id`, `addresses_id`) VALUES(1, 2);
INSERT INTO `transaction`.`customer_address` (`customer_id`, `addresses_id`) VALUES(2, 3);
